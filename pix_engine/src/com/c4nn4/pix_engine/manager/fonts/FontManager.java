package com.c4nn4.pix_engine.manager.fonts;

import com.c4nn4.pix_engine.main.screen.Screen;
import com.c4nn4.pix_engine.main.screen.ResolutionChangedListener;
...
public class FontManager implements ResolutionChangedListener {
    ...
    private static Font createFont(String fontName, int size) {
        ...
        try {
            ...
            myStream = Content.class.getResourceAsStream("/com/c4nn4/resources/Fonts/" + fontName + ".ttf");
