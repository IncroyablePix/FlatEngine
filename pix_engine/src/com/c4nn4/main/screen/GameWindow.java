package com.c4nn4.main.screen;

import com.c4nn4.game.GameState;
import com.c4nn4.graphics.DisplayThread;
import com.c4nn4.graphics.render.GRenderer;
...
import com.c4nn4.manager.fonts.FontManager;
...
public class GameWindow extends JPanel implements ResolutionChangedListener {
    ...
    public <E> GameWindow(JFrame window, Screen screen, String gameTitle, Constructor<? extends GameState> constructor) throws IllegalAccessException, InstantiationException, InvocationTargetException {
        this.window = window;
