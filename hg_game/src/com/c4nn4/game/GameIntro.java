...
import com.c4nn4.menu.MainMenu;
...
public class GameIntro extends GameState {
    ...
    public GameIntro(final GameStateManager gsm) {
        ...
        am = AudioManager.get();
        am.load("/com/c4nn4/resources/Sound/Music/silhouette.mp3", "intro");
        ...
        try {
            logo[0] = ImageIO.read(this.getClass().getResourceAsStream("/com/c4nn4/resources/Graphics/Others/SILHOUETTE.png"));
            logo[1] = ImageIO.read(this.getClass().getResourceAsStream("/com/c4nn4/resources/Graphics/Others/INTRO.png"));
        }
        catch (Exception e) {
            e.printStackTrace();
        }
