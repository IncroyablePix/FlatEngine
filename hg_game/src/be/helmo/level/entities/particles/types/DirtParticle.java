...
public class DirtParticle implements ParticleFabric {
    private final double x, y;
    private final ParticlesInitialVelSet initialVelSet;

    public DirtParticle(double x, double y) {
        this.x = x;
        this.y = y;
    ...
    public ActiveSprite getActiveSprite() {
        return new ActiveSprite(x, y, 1, PixManager.get().getSprite("DIRT", 0));//PixManager.get().dirt()
    }
